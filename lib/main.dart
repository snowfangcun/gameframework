...
var themedData = ThemeData(
    //  primaryColor: Colors.black,
    //  primarySwatch: Colors.blue,
    // ColorScheme.fromSeed 根据给定的种子颜色生成一组主题颜色
    colorScheme: ColorScheme.fromSeed(
        brightness: Brightness.light,
        seedColor: const Color.fromARGB(255, 51, 42, 42)),
    useMaterial3: true);

extension AppThemeData on ThemeData {
  Color get success => const Color(0xFF123456);
}
...
class _AppPageState extends State<AppPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Row(children: [Link(text: 'helo world 666')]),
    );
  }
}
